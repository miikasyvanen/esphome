...
internalfs_ns = cg.esphome_ns.namespace("internalfs")
InternalFSComponent = internalfs_ns.class_("InternalFSComponent", cg.Component)

InternalFS = internalfs_ns.class_("InternalFS", cg.Component)

Partitions = internalfs_ns.class_("Partitions")
Partition = internalfs_ns.class_("Partition", Partitions)
...
CONFIG_SCHEMA = cv.All(
    cv.Schema(
        {
            cv.Required(CONF_ID): cv.declare_id(InternalFS),
